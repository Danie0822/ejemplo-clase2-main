...
const App = () => {
  ...
  const agregarCliente = () => {
    ...
    const nuevoCliente = { id: idCounter + 1, nombre: nombre, fechaReserva: fechaReserva, reserva: reserva };
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          ...
          >
            ...
            <Text style={styles.clienteNombre}>{item.reserva}</Text>
